...
| **Directiva Nacional por cuatrienio** | Hecho: selector de cuatrienio en el título de `/level/national` (misma tabla que la directiva actual), organigramas históricos, edición (Administrador Global y Oficina Nacional), Director Nacional permanente y ex comandantes en el Consejo Ejecutivo. Falta correr la carga del listado 2022-2026 (la lanza el Administrador Global) y trasladar a su destacamento a quienes queden en "Provisional". Ver `docs/directiva-por-cuatrienio.md`. |
