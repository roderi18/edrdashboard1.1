...
| **Sistema de ascenso**          | `.../edit/awards`                                       | Catálogo de 490 premios transcrito del inventario oficial. Cada carpeta de premios en cuadrícula con tarjeta de insignia, check por certificado y completado por lotes: `docs/premios-tarjeta-de-insignia.md`.                                                                                                                                                                                                                                     |
