...
//
//   node crear-parche-registro-2026.mjs           -> simulacion
//   node crear-parche-registro-2026.mjs --aplicar -> escribe de verdad
// ----------------------------------------------------------------------
...
// --- Lo que se crea ---------------------------------------------------------
// El parche del registro 2026. Un solo precio —RD$200— para registrados y no
// registrados, porque no se dio otro. Renglon GENERAL: no se gana cursando como
// los de adiestramiento. Cantidad 10, como los lotes anteriores.
const TODOS = [
  {
  ...
  for (const p of TODOS) {
    ...
    if (APLICAR) {
      ...
      await auditRef.set({
        ...
        origen: 'script',
        metadatos: { ambito: 'tienda', lote: 'alta-parche-registro-2026' },
