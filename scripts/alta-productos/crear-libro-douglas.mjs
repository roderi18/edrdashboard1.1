...
//
//   node crear-libro-douglas.mjs           -> simulacion
//   node crear-libro-douglas.mjs --aplicar -> escribe de verdad
// ----------------------------------------------------------------------
...
// --- Lo que se crea ---------------------------------------------------------
// Un libro. Un solo precio —RD$500— para registrados y no registrados, porque no
// se dio otro. Renglon GENERAL: un libro lo compra cualquiera, no se gana
// cursando como los parches. Cantidad 10, como los lotes anteriores.
const TODOS = [
  {
  ...
  for (const p of TODOS) {
    ...
    if (APLICAR) {
      ...
      await auditRef.set({
        ...
        origen: 'script',
        metadatos: { ambito: 'tienda', lote: 'alta-libro-douglas-marsh' },
