...
//
// Uso: node scripts/perf-levels.mjs [baseURL] [iteraciones]
...
// --- Waterfalls que imitan el código actual de cada vista ---

const regionalView = async () => {
...
const VIEWS = {
  Regiones: regionalView,
  Secciones: sectionalView,
  Destacamentos: destView,
  Miembros: memberView,
};
...
const run = async () => {
  console.log(`Base: ${BASE} | iteraciones medidas: ${ITERS} (+1 warmup)\n`);
  const results = {};
