...
export const paths = {
  ...
  auth: {
    ...
    firebase: {
      ...
      primerAcceso: `${ROOTS.AUTH}/firebase/primer-acceso`,
  ...
  dashboard: {
    ...
    level: {
      ...
      member: {
        ...
        editDest: (id) => `/dashboard/level/member/${id}/edit/dest`,
        editHealth: (id) => `/dashboard/level/member/${id}/edit/health`,
        editAwards: (id) => `/dashboard/level/member/${id}/edit/awards`,
        editParents: (id) => `/dashboard/level/member/${id}/edit/parents`,
        editHistory: (id) => `/dashboard/level/member/${id}/edit/history`,
      },
    },
    product: {
