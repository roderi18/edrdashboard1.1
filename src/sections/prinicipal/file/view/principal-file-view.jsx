...
import { FileStoragePrincipal } from '../../../file-manager/file-storage-principal';
...
export function PrincipalFileView() {
  ...
  const renderStoragePrincipal = () => (
    <FileStoragePrincipal
      total={GB}
      chart={{ series: 76 }}
      data={[
        {
        ...
        <Grid container spacing={3}>
          ...
          <Grid size={{ xs: 12, md: 6, lg: 4 }}>
            <Box sx={{ gap: 3, display: 'flex', flexDirection: 'column' }}>
              ...
              <Box sx={{ display: { xs: 'none', sm: 'block' } }}>{renderStoragePrincipal()}</Box>
