...
import { FileManagerPanel } from './logs-file-manager-panel';
import { FileManagerFileItem } from './logs-file-manager-file-item';
import { FileManagerFolderItem } from './logs-file-manager-folder-item';
import { FileManagerShareDialog } from './logs-file-manager-share-dialog';
import { FileManagerActionSelected } from './logs-file-manager-action-selected';
import { FileManagerCreateFolderDialog } from './logs-file-manager-create-folder-dialog';
        ...
        >
          {dataFiltered
            ...
            .map((file) => (
              <FileManagerFileItem
                key={file.id}
                file={{ ...file, memberId: table.memberId }}
