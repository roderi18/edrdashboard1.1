...
export function MemberCreateEditForm({ currentMember }) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      reset();
      toast.success(currentMember ? 'Update success!' : 'Create success!');
            ...
            <Field.Switch
              ...
              label={
                <>
                  ...
                  <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                    Disabling this will automatically send the member a verification email
                  </Typography>
                </>
              }
          ...
          <Card sx={{ p: 3 }}>
            ...
            <Stack sx={{ mt: 3, alignItems: 'flex-end' }}>
              <Button type="submit" variant="contained" loading={isSubmitting}>
                {!currentMember ? 'Crear miembro' : 'Guardar cambios'}
              </Button>
            </Stack>
          </Card>
        </Grid>
