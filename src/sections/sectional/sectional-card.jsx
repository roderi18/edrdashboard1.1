...
export function SectionalCard({ sectional, sx, ...other }) {
  return (
    <Card sx={[{ textAlign: 'center' }, ...(Array.isArray(sx) ? sx : [sx])]} {...other}>
      ...
      >
        {[
          { label: 'Follower', value: sectional.totalFollowers },
          { label: 'Following', value: sectional.totalFollowing },
          { label: 'Total post', value: sectional.totalPosts },
        ].map((stat) => (
