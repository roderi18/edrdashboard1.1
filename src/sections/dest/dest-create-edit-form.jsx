...
export function DestCreateEditForm({ currentDest }) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      reset();
      toast.success(currentDest ? 'Update success!' : 'Create success!');
      router.push(paths.dashboard.level.dest); //anteriormente .list
            ...
            <Field.Switch
              ...
              label={
                <>
                  ...
                  <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                    Disabling this will automatically send the dest a verification email
                  </Typography>
                </>
              }
          ...
          <Card sx={{ p: 3 }}>
            ...
            <Stack sx={{ mt: 3, alignItems: 'flex-end' }}>
              <Button type="submit" variant="contained" loading={isSubmitting}>
                {!currentDest ? 'Create dest' : 'Save changes'}
              </Button>
            </Stack>
          </Card>
        </Grid>
