...
export function LevelCreateEditForm({ currentLevel }) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      reset();
      toast.success(currentLevel ? 'Actualización exitosa!' : 'Create success!');
      router.push(paths.dashboard.level.list);
          ...
          <Card sx={{ p: 3 }}>
            ...
            <Stack sx={{ mt: 3, alignItems: 'flex-end' }}>
              <Button type="submit" variant="contained" loading={isSubmitting}>
                {!currentLevel ? 'Create level' : 'Guardar cambios'}
              </Button>
            </Stack>
          </Card>
        </Grid>
