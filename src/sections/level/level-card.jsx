...
export function LevelCard({ level, sx, ...other }) {
  return (
    <Card sx={[{ textAlign: 'center' }, ...(Array.isArray(sx) ? sx : [sx])]} {...other}>
      ...
      >
        {[
          { label: 'Follower', value: level.totalFollowers },
          { label: 'Following', value: level.totalFollowing },
          { label: 'Total post', value: level.totalPosts },
        ].map((stat) => (
