...
export default function Page() {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      // El documento y la librería de PDF se cargan aquí, al pulsar: antes
      // viajaban con la pestaña Directiva aunque nadie descargara el organigrama.
      const { generarPdfDeLaDirectiva } = await import(
        'src/sections/dest/leadership/dest-leadership-pdf'
      );
      const blob = await generarPdfDeLaDirectiva({ destName: destNombreCompleto, chartData });
