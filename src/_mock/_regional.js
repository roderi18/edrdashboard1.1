...
export const _regionalFollowers = Array.from({ length: 18 }, (_, index) => ({
  id: _mock.id(index),
  // regionalName: _mock.regionalName(index),
  regionalId: REGIONALS[index % REGIONALS.length].id,
  regionalName: REGIONALS[index % REGIONALS.length].name,
...
export const _regionalFeeds = Array.from({ length: 3 }, (_, index) => ({
  ...
  personLikes: Array.from({ length: 4 }, (__, personIndex) => ({
    // regionalName: _mock.regionalName(personIndex),
    regionalName: REGIONALS[personIndex % REGIONALS.length].name,
  ...
  comments: (index === 2 && []) || [
    {
      ...
      author: {
        ...
        // regionalName: _mock.regionalName(index + 5),
        regionalId: REGIONALS[index % REGIONALS.length].id
      },
