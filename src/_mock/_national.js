...
export const _nationalFollowers = Array.from({ length: 18 }, (_, index) => ({
  id: _mock.id(index),
  nationalXname: _mock.memberFullName(index),
...
export const _nationalFeeds = Array.from({ length: 3 }, (_, index) => ({
  ...
  personLikes: Array.from({ length: 20 }, (__, personIndex) => ({
    nationalXname: _mock.memberFullName(personIndex),
  ...
  comments: (index === 2 && []) || [
    {
      ...
      author: {
        ...
        nationalXname: _mock.memberFullName(index + 5),
      },
    ...
    },
    {
      ...
      author: {
        ...
        nationalXname: _mock.memberFullName(index + 6),
      },
