...
export const _notifications = Array.from({ length: 9 }, (_, index) => ({
  ...
  title:
    ...
    (index === 1 &&
      `<p><strong>Jayvon Hull</strong> te mencionó en <strong><a href='#'>Sección...</a></strong></p>`) ||
    (index === 2 &&
      `<p><strong>Lainey Davidson</strong> agregó un archivo <strong><a href='#'>Gestor archivos</a></strong></p>`) ||
    (index === 3 &&
      `<p><strong>Angelique Morse</strong> agergó un nuevo tag a <strong><a href='#'>Gestor archivos<a/></strong></p>`) ||
    (index === 4 &&
      `<p><strong>Giana Brandt</strong> solicitó un pago de<strong>$200</strong></p>`) ||
    (index === 5 && `<p>Tu orden espera por ser enviada</p>`) ||
    (index === 6 && `<p>Envío procesándose para ser enviado</p>`) ||
    (index === 7 && `<p>Tienes 5 mensajes sin leer</p>`) ||
    (index === 8 && `<p>Tienes un nuevo mensaje`) ||
    '',
}));
