...
export const _levelFollowers = Array.from({ length: 18 }, (_, index) => ({
  id: _mock.id(index),
...
export const _levelFriends = Array.from({ length: 18 }, (_, index) => ({
  id: _mock.id(index),
...
export const _levelGallery = Array.from({ length: 12 }, (_, index) => ({
  id: _mock.id(index),
...
export const _levelFeeds = Array.from({ length: 3 }, (_, index) => ({
  id: _mock.id(index),
...
export const _levelCards = Array.from({ length: 21 }, (_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _levelPayment = Array.from({ length: 3 }, (_, index) => ({
  id: _mock.id(index),
...
export const _levelAddressBook = Array.from({ length: 4 }, (_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _levelInvoices = Array.from({ length: 10 }, (_, index) => ({
  id: _mock.id(index),
...
export const _levelList = Array.from({ length: 20 }, (_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
