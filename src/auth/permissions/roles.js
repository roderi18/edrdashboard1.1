export const ROLES = {
  ...
  // Cargos de consulta (solo lectura) del desplegable. Capellán Regional es de
  // nivel región; los demás son de nivel sección.
  CAPELLAN_REGIONAL: 'capellan_regional',
  CAPELLAN_SECCIONAL: 'capellan_seccional',
...
export const ROLES_CATALOGO = [
  ...
  {
    codigo: ROLES.CAPELLAN_REGIONAL,
    nombre: 'Capellán Regional',
    descripcion: 'Consulta de solo lectura de los miembros de su region (datos sensibles enmascarados).',
    alcancePredeterminado: ALCANCES.REGION,
    asignableDesdeAdministradores: true,
    activo: true,
  },
  {
    codigo: ROLES.CAPELLAN_SECCIONAL,
    nombre: 'Capellán Seccional',
  ...
  {
    codigo: ROLES.GRUPOS_LOCALES,
    nombre: 'Grupos Locales',
    descripcion: 'Consulta de solo lectura de los miembros y destacamentos de su seccion (datos sensibles enmascarados).',
    alcancePredeterminado: ALCANCES.SECCION,
    asignableDesdeAdministradores: true,
    activo: true,
