...
const DIRECTIVA_POSITIONS_DECLARADAS = [
  ...
  createPosition({
    ...
    nivel: DIRECTIVA_LEVELS.seccional,
    // "Coordinador Seccional" y "Director Seccional" son el mismo cargo: se
    // llama Director. El id no cambia (lo llevan las asignaciones guardadas).
    nombreCargo: 'Director Seccional',
